	...
	if (CURRENT_ENGINE === 'MV') {
		...
		Game_Interpreter.prototype.pluginCommand = function(command, args) {
			...
			if ((command || '').toLowerCase() === 'animmgr') {
				...
				else if (subCommand === 'setparam') { // setParam
